...
\section{Discussion}
\cref{fig:fvsi,fig:omegagraphs} show a clear deviation from expected values that cannot be accounted for by the uncertainty. It should be noted, however, that no uncertainty could be provided for the expected values as none were provided for the quantites used in their calculation, which were obtained externally. 
